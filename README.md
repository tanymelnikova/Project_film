...
Основная аудитория паблика «ПленКа» – москвичи. Примерно половину от их количества составляют петербуржцы. За ними следуют подписчики из Киева.
...
**График распределения по возрасту участников паблика "無秩序と工芸"**
...
**График распределения по возрасту участников паблика "ПленКа"**
...
**График распределения по возрасту участников паблика "зелёная зона"**
...
**График распределения по возрасту участников паблика "Плёнка"**
...
При сравнении среднего возраста среди подписчиков мужского и женского полов мы пришли к выводу, что они примерно одинаковы. И все же среди подписчиков сообществ «無秩序と工芸», "Плёнка" и «ПленКа» средний возраст женщин подписчиков немного ниже, в то время как в паблике «Зелёная зон» а наблюдается обратная тенденция. Также можно сделать вывод о том, что женская аудитория пабликов "Зелёная зона" и "無秩序と工芸" моложе, чем в пабликах "Плёнка" и "ПленКа": в статистически значимую выборку участников в группах "Зелёная зона" и "無秩序と工芸" попадают также женщины, родившиеся в начале 2000-х. Интересно отметить, что распределение по годам рождения среди подписчиков мужского пола шире во всех четырёх исследованных группах.

**График распределения мужчин и женщин по возрасту паблика "無秩序と工芸"**

![image is here](FM_bt.png)

График показывает, что женщины и мужчины, подписанные на этот паблик, в среднем близки по возрасту. Однако средний возраст женщин чуть ниже.
...
График демонстрирует нам некоторый разрыв в возрасте участников женского и мужского пола: если для женщин медианным годом рождения является 2000 год, то для мужчин - конец 1990-х.
...
Не менее важным для нашего исследования оказался анализ широкой аудитории: подписчиков всех четырёх исследованных пабликов. На основании этих данных мы сделали следующие выводы:
...
Женская аудитория любителей плёночной фотографии моложе, чем мужская, но незначительно. Статистически значимая выборка годов рождения женщин приходится на вторую половину 1990-х и начало 2000-х годов, тогда как для мужской аудитории этот промежуток шире и включает в себя 1990-е годы. Медианный год рождения мужчин и женщин близок и приходится на конец 1990-х годов.

Важной частью нашего исследования стал анализ постов позволил, который нам выявить, на какие пленки и фотоаппараты снимают чаще, а также в какие периоды популярность плёночной фотографии достигала своего пика:


**Упоминания в постах плёнок разнличных фирм**

Тип пленки                |無秩序と工芸 | Плёнка | Зелёная зона | ПленКа | Всего |
--------------------------|-------    |------  |--------------|------- |-------|
kodak                     |     2221  | 3264   | 1155         | 23 | 6663 |
fuji                      |      1638 |   1539 | 438          | 2 | 3617 |
ilford                    |       335 | 1225   | 138          | 8 | 1706 |
portra                    |           |  965   | 114          | 9 | 1088 |

Таким образом, наиболее популярными среди любителей плёночной фотографии являются фотоплёнки фирмы "Kodak"

**Упоминания в постах камер различных фирм**

Название фотоаппарата     |無秩序と工芸 | Плёнка | Зелёная зона | ПленКа | Всего |
--------------------------|-------    |------  |--------------|------- |----|
olympus                   |      1820 |   818  | 757          | 8 | 3403 |
canon                     |      825  |  1779  | 548          | 9 | 3161 |
zenit / зенит             |    539       |   949  | 410          | 5 | 1903 |
nikon                     |      319     |  1128  | 219          | 7 | 1637 |
pentax                    |     204      |    707 | 139          | 3 | 1053 |
samsung                   |      266      |    0    | 89          | 0 |927 |
minolta                   |      255     |  507   | 154          | 0 | 916 |
mamiya                    |     -      | 500    |              | 0       | 500|
yashica                   | 126       |        |              |         |126 |

Из частоты упоминаний в постах фотоаппаратов различных фирм можно сделать вывод, что чаще всего фотолюбители снимают на камеры фирм "Olympus" и "Canon", затем с большим отрывом идут "Зенит" и "Nikon".
...
Пик популяроности плёночной фотографии пришёлся на 2013 год: этот год упоминается в почти 9000 постов на эту тему. Примечательно, что все они выложены в паблике "Плёнка", и никакой другой год не упоминается в этом паблике так же часто. В таблице также видны годы образования каждого паблика. Самым "старым" из исследуемым пабликов является "Плёнка", образованный в 2011 году, а самым "молодым" - ПленКа. 
